...
TODO:
1. все в метрах
2. разбиение сетки отклика на квадраты
3. кривое обновление ячеек при большом кол-ве измерений с разных уголов
4. нижн. граница k при обновлении ячеек с s == r
5. другой векторизатор
